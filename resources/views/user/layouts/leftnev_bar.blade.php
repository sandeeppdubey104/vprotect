    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
         ...
         <li class="nav-item">
            <a class="nav-link" href="{{ route('home.sale_sub') }}">
              <i class="ni ni-planet text-blue"></i> Sales Subscriptions
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('home.invoices') }}">
              <i class="ni ni-bullet-list-67 text-primary"></i> Invoices
            </a>
          </li>  
          <li class="nav-item">
            <a class="nav-link" href="{{ route('home.payments') }}">
              <i class="ni ni-bullet-list-67 text-primary"></i> Payments
            </a>
          </li>  
          <li class="nav-item">
            <a class="nav-link" href="{{route('pay.advpaymentget')}}">
              <i class="ni ni-bullet-list-67 text-primary"></i> Pay Advance
            </a>
          </li>       
          <li class="nav-item">
